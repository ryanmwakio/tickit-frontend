...
import { groupEventsByCategory, isEventPast, getEventStatus } from "@/lib/event-utils";
...
export function EventShowcase() {
  ...
  if (loading) {
    return (
      <section className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-14 lg:py-16 text-slate-900" id="events">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  <p className="text-xs uppercase tracking-[0.3em] text-slate-500">
                    {group.events.length} event{group.events.length !== 1 ? "s" : ""} available
                  </p>
                  ...
                  {group.events.slice(0, 8).map((event) => {
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-2 mt-4">
                        ...
                        <p className="text-sm font-semibold line-clamp-2 leading-tight">{event.title}</p>
                        <p className="text-xs text-slate-500">{event.dateCard || event.dateFull}</p>
                        {event.tags.length > 0 && (
                ...
                <div className="hidden lg:contents">
                  {group.events.slice(0, 8).map((event) => {
                    ...
                    >
                      ...
                      <p className="mt-1 text-lg font-semibold line-clamp-2">{event.title}</p>
                      <p className="text-sm text-slate-500">{event.dateCard || event.dateFull}</p>
                      {event.tags.length > 0 && (
                      ...
                      <div className="mt-4 flex items-center justify-between">
                        ...
                        <span className={`inline-flex items-center gap-1 rounded-full px-4 py-1.5 text-xs font-semibold uppercase tracking-wide ${
                          isPast 
