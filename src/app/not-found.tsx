...
import { Home, Search, ArrowLeft, Sparkles, Music, PartyPopper } from "lucide-react";

// Cheerful event images
const eventImages = [
    ...
    <div className="flex min-h-screen flex-col bg-white text-slate-900 overflow-x-hidden relative">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {eventImages.map((img, idx) => (
          ...
          >
            <div className="relative w-28 h-28 sm:w-36 sm:h-36 lg:w-44 lg:h-44 rounded-3xl overflow-hidden shadow-2xl shadow-slate-900/25 border-2 border-white/80 backdrop-blur-sm">
              <Image
                src={img}
                alt="Event"
                fill
      ...
      <div className="relative flex flex-1 items-center justify-center px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 z-10">
        <div className="relative mx-auto w-full max-w-5xl">
          ...
          <div className="relative rounded-[40px] border border-slate-200/80 bg-white/80 backdrop-blur-xl p-8 sm:p-12 lg:p-16 shadow-2xl shadow-slate-900/10">
            <div className="text-center">
              {/* Badge */}
              <div className="inline-flex items-center gap-2.5 rounded-full border border-slate-200 bg-gradient-to-r from-white to-slate-50 px-5 py-2.5 text-xs font-semibold uppercase tracking-[0.4em] text-slate-600 shadow-lg shadow-slate-200/60 mb-10 animate-fade-in-up delay-100">
              ...
              <div className="mb-8 animate-fade-in-up delay-200">
                <div className="relative inline-block">
                  <h1 className="text-8xl sm:text-9xl lg:text-[12rem] font-bold text-slate-900 leading-none tracking-tight">
                    <span className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 bg-clip-text text-transparent">
                      404
                      <span className="absolute -top-2 -right-2 text-amber-400 opacity-20 blur-xl">404</span>
                    </span>
                  </h1>
                </div>
              </div>
              ...
              <div className="space-y-5 mb-12 animate-fade-in-up delay-300">
                ...
                <p className="text-lg sm:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
                  The event you&apos;re looking for might have been moved, removed, or never existed. 
                ...
                <div className="flex items-center justify-center gap-3 mt-8">
                  <div className="flex items-center gap-2 rounded-full bg-amber-50 px-4 py-2 border border-amber-100">
                    <Music className="size-5 text-amber-500 animate-pulse" />
                    <span className="text-sm font-medium text-amber-700">Live Events</span>
                  </div>
                  <div className="flex items-center gap-2 rounded-full bg-indigo-50 px-4 py-2 border border-indigo-100">
                    <PartyPopper className="size-5 text-indigo-500 animate-pulse" />
                    <span className="text-sm font-medium text-indigo-700">Premium</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 mb-10 animate-fade-in-up delay-400">
                ...
                >
                  <div className="flex flex-col items-center text-center space-y-4">
                    <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-5 group-hover:from-slate-100 group-hover:to-slate-50 transition-all shadow-sm">
                      <Search className="size-7 text-slate-900" />
                    </div>
                    <div>
                      <p className="text-base font-semibold text-slate-900">Browse Events</p>
                      <p className="text-xs text-slate-500 mt-1.5">Discover experiences</p>
                    </div>
                  </div>
                  <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-indigo-50/0 to-indigo-50/0 group-hover:from-indigo-50/50 group-hover:to-indigo-50/0 transition-all duration-300 pointer-events-none" />
                </Link>
              ...
              <div className="rounded-3xl border border-slate-200/80 bg-gradient-to-br from-white/95 to-slate-50/95 p-8 shadow-lg shadow-slate-200/60 backdrop-blur-sm animate-fade-in-up delay-500">
                <p className="text-xs font-semibold uppercase tracking-[0.4em] text-slate-500 mb-6">
                  Quick Links
                </p>
